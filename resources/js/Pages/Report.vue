        ...
        <div class="px-4 pt-6">
            <div class="mb-8">
                ...
                <span
                    ...
                    >This is the reports about recruitment process</span>
            </div>
            <div
                ...
                <div class="flex mb-8">
                    <div class="relative w-48 sm:w-64">
                        <SelectInput
                            ...
                            label="Select Month"
                            :canSearch="false"
                            :disabled="isOverallReport "
                        >
                            <option
                                value="January"
                                :selected="selectMonth === 'January'"
                            >
                                January
                            </option>
                            ...
                            <option
                                value="September"
                                :selected="selectMonth === 'September'"
                            >
                                September
                            </option>
                ...
                <div class="flex mb-8">
                    <div class="relative w-48 sm:w-64">
                        ...
                        >
                            <option
                                value="2023"
                                :selected="reportType === '2023'"
                            >
                                2023
                            </option>
                            <option
                                value="2024"
                                :selected="reportType === '2024'"
                            >
                                2024
                            </option>
                        </SelectInput>
